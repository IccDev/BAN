...
#pdpCartes-extend{
    ...
    #formulaire {
  	...
  	@keyframes animatezoom {
  		...
  		80%  {bottom: 0;}
  		100% {background-color: background-color: rgb(32 32 35);}
	}
  	@keyframes closeForm {
  		0%   {right: -120px;}
  		90%  {right: -120px;}
	...
	margin-bottom:15%;
        ...
        <form id="formSearchAnnuaire" >
          <div id="barre-recherche">
            ...
            <button onclick="performSearch()" type="submit" class="recherche">
...
function myMove() {
  ...
  elem.classList.add('blury');
   ...
   <script>// Fonction pour effectuer la recherche et afficher les résultats
function performSearch() {
  ...
  if (searchInput || selectedChurch) {
    // Crée un objet pour stocker les paramètres de recherche
    var searchParams = {};

    if (selectedChurch) {
      searchParams.church = selectedChurch;
    }

    if (searchInput) {
      searchParams.key = searchInput;
    }

    // Convertit l'objet de paramètres en une chaîne de requête URL
